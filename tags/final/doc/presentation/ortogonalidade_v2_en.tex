...
\begin{frame}{Padrões Freqüentes}
	\begin{itemize}[<+-| alert@+>]
		...
		\begin{itemize}[<+-| alert@+>]
			\item Padrões freqüentes obedecem à propriedade de anti-monotonia;
...
\begin{frame}{Métricas de Ortogonalidade}
	\begin{itemize}[<+-| alert@+>]
		...
		\item O complemento do coeficiente de \textbf{Jaccard} aplicado à cobertura da base de dados pode ser considerado como uma métrica de ortogonalidade entre dois padrões: \[D(p_1,p_2) = 1 - \frac{|TS(p_1) \cap TS(p_2)|}{|TS(p_1) \cup TS(p_2)|},\] onde $TS(p)$ é o conjunto de transações cobertas por $p$.
...
\begin{frame}{Exemplo de Execução da Heurística}

	\begin{overprint}
		\onslide<2-5>
			Padrões Freqüentes: \{\alert<5>{ABC},BC,A,B\}
		\onslide<6-8>
			Padrões Freqüentes: \{\st{ABC},\alert<8>{BC},A,B\}
		\onslide<9-14>
			Padrões Freqüentes: \{\st{ABC},\st{BC},\alert<11-14>{A},B\}
		\onslide<15-22>
			Padrões Freqüentes: \{\alert<22>{ABC},\st{BC},\st{A},\alert<16-19>{B}\}
		\onslide<23-28>
			Padrões Freqüentes: \{\st{ABC},\st{BC},\st{A},\alert<25-28>{B}\}
		\onslide<29>
			Padrões Freqüentes: \{\st{ABC},BC,\st{A},\st{B}\}
		\onslide<30>
			Padrões Freqüentes: \{ABC,BC,A,B\}
	\end{overprint}
	...
	\begin{overprint}
		\onslide<3-5>
			Padrões Ortogonais: \{\}
		\onslide<6-8>
			Padrões Ortogonais: \{ABC\}
		\onslide<9-14>
			Padrões Ortogonais: \{\alert<12-14>{ABC},BC\}
		\onslide<15-22>
			Padrões Ortogonais: \{A,\alert<17-19>{BC}\}
		\onslide<23-28>
			Padrões Ortogonais: \{A,\alert<26-28>{BC},ABC\}
		\onslide<29>
			Padrões Ortogonais: \{A,B,ABC\}
	\end{overprint}
	\begin{overprint}
		\onslide<4-9>
			Ortogonalidade: $-$
	...
	\begin{overprint}
		\onslide<13-14>
			Padrões Ortogonais (c): \{A,BC\}
		\onslide<18-19>
			Padrões Ortogonais (c): \{A,B\}
		\onslide<27-28>
			Padrões Ortogonais (c): \{A,B,ABC\}
	\end{overprint}
	\begin{overprint}
		\onslide<14>
	...
	\begin{overprint}
		\onslide<7-20>
			Padrões Ortogonais (r): \{ABC\}
		\onslide<21-30>
			Padrões Ortogonais (r): \alert<30>{\{A,BC\}}
	\end{overprint}
	\begin{overprint}
		\onslide<7-20>
