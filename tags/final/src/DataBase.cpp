...
void DataBase::ClassifyTestData (const RunMode &rRunMode, const PatternList::OrtMode &rOrtMode, const PatternList::OrtMethod &rOrtMethod, const Pattern::OrtMetric &rOrtMetric, const PatternList::OrtOrdering &rOrtOrdering, const RankingRule::RuleMeasure &rRuleMeasure, const uint32 &rMinNumRules, const uint32 &rMaxNumRankRules, const Transaction::PatternSet &rPatternSet, const float32 &rClassCoverageFactor, const float32 &rAlpha, const float32 &rBeta)
{
	...
	try
	{
		for (TransactionList::STLTransactionList_cit it = mTestTransactionList.GetBegin (); it != itEnd; ++it)
			ClassifyTransaction (static_cast<Transaction *>(*it), rRunMode, rOrtMode, rOrtMethod, rOrtMetric, rOrtOrdering, rRuleMeasure, rMinNumRules, rMaxNumRankRules, rPatternSet, rClassCoverageFactor, rAlpha, rBeta);
...
void DataBase::ClassifyTransaction (Transaction *pTransaction, const RunMode &rRunMode, const PatternList::OrtMode &rOrtMode, const PatternList::OrtMethod &rOrtMethod, const Pattern::OrtMetric &rOrtMetric, const PatternList::OrtOrdering &rOrtOrdering, const RankingRule::RuleMeasure &rRuleMeasure, const uint32 &rMinNumRules, const uint32 &rMaxNumRankRules, const Transaction::PatternSet &rPatternSet, const float32 &rClassCoverageFactor, const float32 &rAlpha, const float32 &rBeta)
{
	...
	else if (rRunMode == MODE_ORTHOGONAL)
	{
		...
		PatternList *pOrthogonalFrequentPatternList = pPatternList->GetOrthogonalPatternList (mpProjectionTransactionList, rOrtMode, rOrtMethod, rOrtMetric, rOrtOrdering, rClassCoverageFactor, rAlpha, rBeta, orth_rate);
