...
Now, we will show some graphics comparing the executions of the three approaches implemented in OLAC and LAC, the lazy associative classifier impelemted in \cite{Veloso06Lazy}, but first we will do some observations about these test instances:
\par
\begin{itemize}
...
\begin{figure}[htbp]
	\centering
	\includegraphics{graphs/histogram_acc}
...
\begin{figure}[htbp]
	\centering
	\includegraphics{graphs/histogram_pat}
...
\begin{figure}[htbp]
	\centering
	\includegraphics{graphs/histogram_rul}
...
\begin{figure}[htbp]
	\centering
	\includegraphics{graphs/bst_histogram_acc}
...
\begin{figure}[htbp]
	\centering
	\includegraphics{graphs/bst_histogram_pat}
...
\begin{figure}[htbp]
	\centering
	\includegraphics{graphs/bst_histogram_rul}
