...
set output 'output/graphs/histogram_best_run_for_avg_db_ometric_rul.eps'
...
set title "Orthogonality Metrics Rules Average Histogram"
set xlabel "Data Sets"
set ylabel "Rules Average"
plot 'output/graphs/histogram_best_run_for_avg_db_ometric_rul.dat' using 2:xtic(1) ti col, '' u 3 ti col, '' u 4 ti col, '' u 5 ti col