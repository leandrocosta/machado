...
set output 'output/graphs/histogram_best_run_for_avg_db_ometric_tim.eps'
...
set title "Orthogonality Metrics Classification Time Average Histogram"
set xlabel "Data Sets"
set ylabel "Classification Time Average"
plot 'output/graphs/histogram_best_run_for_avg_db_ometric_tim.dat' using 2:xtic(1) ti col, '' u 3 ti col, '' u 4 ti col, '' u 5 ti col