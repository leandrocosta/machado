...
\par
Como exemplo, suponha um conjunto de itens $\I = \left\{A, B, C, D, E \right\}$ e um conjunto de padrões: $\F = \left\{ AB, ABC \right\}$. Na tabela \ref{tab:item_w1} encontramos o valor do peso de cada item, de acordo com a expressão apresentada. Os itens $D$ e $E$ não possuem pesos, pelo fato de não serem encontrados nos padrões.
...
\par
Suponha uma base de dados $\D$ em que as transações e suas respectivas classes são encontradas na tabela \ref{tab:classe_db}.
