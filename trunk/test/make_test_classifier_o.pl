...
#		0.4,	# OK (confidence = (0.001, 0.9), max_num_rank_rules = (1))
#		0.5,	# OK (confidence = (0.001, 0.9), max_num_rank_rules = (1))
...
#		0.8,	# OK (confidence = (0.001, 0.9), max_num_rank_rules = (1))
	...
	my @confidence = (
		0.001,	# OK (max_num_rank_rules = (1, 2))
		0.01,
		0.1,
		0.2,
		0.3,
