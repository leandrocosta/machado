										...
										for ($g = 0; $g < scalar @Common::ClassifierOOrderings; $g++)
										{
											for ($u = 0; $u < scalar @Common::ClassifierRMeasures; $u++)
											{
												...
												foreach $data_base (@Common::DataBases)
												{
													...
													make_test_classifier_o ($data_base, $Common::ClassifierSupports[$s], $Common::Confidences[$c], $Common::ClassifierPatternSets[$p], $Common::MinNumRules[$n], $Common::MaxNumRankRules[$l], $Common::ClassifierMinRuleLens[$m], $Common::ClassifierMaxRuleLens[$x], $Common::ClassifierOModes[$o], $Common::ClassifierOMetrics[$e], $Common::ClassifierOMethods[$w], $Common::ClassifierOOrderings[$g], $Common::ClassifierRMeasures[$u], \$tim, \$pat, \$rul, \$acc);
												...
												save_output_file ('average', $Common::ClassifierSupports[$s], $Common::Confidences[$c], $Common::ClassifierPatternSets[$p], $Common::MinNumRules[$n], $Common::MaxNumRankRules[$l], $Common::ClassifierMinRuleLens[$m], $Common::ClassifierMaxRuleLens[$x], $Common::ClassifierOModes[$o], $Common::ClassifierOMetrics[$e], $Common::ClassifierOMethods[$w], $Common::ClassifierOOrderings[$g], $Common::ClassifierRMeasures[$u], $time_avg, $patterns_avg, $rules_avg, $accuracy_avg);
											}
										}
									}
								}
...
sub make_test_classifier_o ($$$$$$$$$$$$$$$$$)
{
	my ($data_base, $support, $confidence, $pattern_set, $min_num_rules, $max_num_rank_rules, $min_rule_len, $max_rule_len, $omode, $ometric, $omethod, $oordering, $rule_measure, $avg_time, $avg_patterns, $avg_rules, $accuracy) = @_;
	...
	{
		my $log_file = "$output_dir/$data_base/s".$support."_c".$confidence."_p".$pattern_set."_n".$min_num_rules."_l".$max_num_rank_rules."_m".$min_rule_len."_x".$max_rule_len."_o".$omode."_e".$ometric."_w".$omethod."_g".$oordering."_u".$rule_measure.".".$fold.".log";

		my ($acc, $pat, $rul, $tim);

		run_classifier_o ($data_base, $fold, $support, $confidence, $pattern_set, $min_num_rules, $max_num_rank_rules, $min_rule_len, $max_rule_len, $omode, $ometric, $omethod, $oordering, $rule_measure, $log_file, \$acc, \$pat, \$rul, \$tim);
	...
	save_output_file ($data_base, $support, $confidence, $pattern_set, $min_num_rules, $max_num_rank_rules, $min_rule_len, $max_rule_len, $omode, $ometric, $omethod, $oordering, $rule_measure, $$avg_time, $$avg_patterns, $$avg_rules, $$accuracy);
}

sub run_classifier_o ($$$$$$$$$$$$$$$$$$$)
{
	my ($data_base, $fold, $support, $confidence, $pattern_set, $min_num_rules, $max_num_rank_rules, $min_rule_len, $max_rule_len, $omode, $ometric, $omethod, $oordering, $rule_measure, $log_file, $accuracy, $avg_patterns, $avg_rules, $avg_time) = @_;

	my $training_file = Common::GetTrainingFile ($data_base, $fold);
	my $testing_file = Common::GetTestingFile ($data_base, $fold);

	print "nice -n 10 $Common::AppClassifier -i $training_file -t $testing_file -s $support -c $confidence -p $pattern_set -n $min_num_rules -l $max_num_rank_rules -m $min_rule_len -x $max_rule_len -r o -o $omode -e $ometric -w $omethod -g $oordering -u $rule_measure -d -1 2&>$log_file\n";
	system "nice -n 10 $Common::AppClassifier -i $training_file -t $testing_file -s $support -c $confidence -p $pattern_set -n $min_num_rules -l $max_num_rank_rules -m $min_rule_len -x $max_rule_len -r o -o $omode -e $ometric -w $omethod -g $oordering -u $rule_measure -d -1 2&>$log_file";
