...
TEST_FILE=test_s$SUPPORT.c$CONFIDENCE.out
...
$APP_CLASSIFIER -i $TIC_TAC_TRAINING -t $TIC_TAC_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$TIC_TAC_C_CLASS
$APP_CLASSIFIER -i $TIC_TAC_TRAINING -t $TIC_TAC_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$TIC_TAC_O_CLASS
...
$APP_CLASSIFIER -i $LYMPH_TRAINING -t $LYMPH_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$LYMPH_C_CLASS
$APP_CLASSIFIER -i $LYMPH_TRAINING -t $LYMPH_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$LYMPH_O_CLASS
...
$APP_CLASSIFIER -i $AUSTRA_TRAINING -t $AUSTRA_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$AUSTRA_C_CLASS
$APP_CLASSIFIER -i $AUSTRA_TRAINING -t $AUSTRA_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$AUSTRA_O_CLASS
...
$APP_CLASSIFIER -i $BREAST_TRAINING -t $BREAST_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$BREAST_C_CLASS
$APP_CLASSIFIER -i $BREAST_TRAINING -t $BREAST_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$BREAST_O_CLASS
...
$APP_CLASSIFIER -i $IRIS_TRAINING -t $IRIS_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$IRIS_C_CLASS
$APP_CLASSIFIER -i $IRIS_TRAINING -t $IRIS_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$IRIS_O_CLASS
...
$APP_CLASSIFIER -i $LABOR_TRAINING -t $LABOR_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$LABOR_C_CLASS
$APP_CLASSIFIER -i $LABOR_TRAINING -t $LABOR_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$LABOR_O_CLASS
...
$APP_CLASSIFIER -i $WINE_TRAINING -t $WINE_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r c -d -1 >$WINE_C_CLASS
$APP_CLASSIFIER -i $WINE_TRAINING -t $WINE_TESTING -s $SUPPORT -c $CONFIDENCE -a 1 -r o -d -1 >$WINE_O_CLASS
