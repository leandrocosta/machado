...
sub run_classifier_c ($$$$$$$$$$)
{
	...
	print "nice -n 10 $APP_CLASSIFIER -i $training_file -t $testing_file -s $support -c $confidence -n $min_num_rules -l $max_num_rank_rules -m $min_rule_len -a $max_rule_len -r c -d -1 2&>$log_file\n";
	system "nice -n 10 $APP_CLASSIFIER -i $training_file -t $testing_file -s $support -c $confidence -n $min_num_rules -l $max_num_rank_rules -m $min_rule_len -a $max_rule_len -r c -d -1 2&>$log_file";
